            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                ...
                <div>
                    <a class="navbar-brand brand-logo" href="/">
                        <img style="width:12vh; height:12vh;" src="{{asset('template/images/dashboard/p.png')}}"
                            alt="logo" />
                    </a>
                    <a class="navbar-brand brand-logo-mini" href="/">
                        <img style="width:11vh; height:5vh;" src="{{asset('template/images/dashboard/p.png')}}"
                            alt="logo" />
                    </a>
                </div>
            </div>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                        <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            {{-- <img class="img-xs rounded-circle" src="{{asset('template/images/faces/pp.jpg')}}"
                            alt="Profile image"> </a> --}}
                        @if(Auth::user()->image)
                        <img class="img-xs rounded-circle" src="{{asset('image/'.Auth::user()->image)}}" alt="">
                        @else
                        <img class="img-xs rounded-circle" src="{{asset('image/'.Auth::user()->image)}}" alt="">
                        @endif
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            <div class="dropdown-header text-center">
                                ...
                                <h5 class="fw-bold text-muted mt-3">{{Auth::user()->name}}</h5>
                                <p>{{Auth::user()->role}}</p>
                            </div>
