            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>{{ $row->total }}</td>
                    <td>
                        {{-- <a href="{{ route('tampilkansales',$row->id) }}"  class="btn btn-info">Edit</a>
                        <a href="/deletesales/{{ $row->id }}" class="btn btn-danger">Delete</a> --}}
                     ...
                     <a href="{{ route('detail',$row->id) }}"> <button type="button" class="btn btn-icon rounded-circle btn-outline-dark">
